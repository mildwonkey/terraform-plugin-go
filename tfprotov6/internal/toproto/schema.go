...
func Schema_NestedType_NestingMode(in tfprotov6.SchemaNestedBlockNestingMode) tfplugin6.Schema_Object_NestingMode {
	return tfplugin6.Schema_Object_NestingMode(in)
}

func Schema_NestedType(in *tfprotov6.SchemaNestedType) (*tfplugin6.Schema_Object, error) {
