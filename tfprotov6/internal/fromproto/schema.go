...
func SchemaNestedTypeNestingMode(in tfplugin6.Schema_Object_NestingMode) tfprotov6.SchemaNestedBlockNestingMode {
	return tfprotov6.SchemaNestedBlockNestingMode(in)
}

func SchemaNestedType(in *tfplugin6.Schema_Object) (*tfprotov6.SchemaNestedType, error) {
	resp := &tfprotov6.SchemaNestedType{
